package com.example.cardeal.logging;

import com.example.cardeal.controllers.AbstractBaseController;
...
public class AspectLogger
{
    ...
    @Around("within(com.example.cardeal.controllers.AbstractBaseController+)")
